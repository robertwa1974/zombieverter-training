...
The ZombieVerter firmware is fully open source, hosted at [github.com/damienmaguire/Stm32-vcu](https://github.com/damienmaguire/Stm32-vcu). When you need something the firmware doesn't yet support, you have three paths — and one of them requires no coding at all.
...
The firmware uses an ARM GCC toolchain. Build documentation is on the openinverter.org wiki. Johannes Huebner's GitHub ([github.com/jsphuebner](https://github.com/jsphuebner)) is the reference for the underlying parameter system and CAN class architecture — understanding his framework is essential for meaningful customisation.
